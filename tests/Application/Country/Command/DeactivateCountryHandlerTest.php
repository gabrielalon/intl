 ...
 * @coversNothing
 */
class DeactivateCountryHandlerTest extends HandlerTestCase
{
    public function setUp(): void
    {
        ...
        $this->register(Command\DeactivateCountryHandler::class, new Command\DeactivateCountryHandler($repository));
    }
     ...
     * @throws \Exception
     */
    public function itDeactivatesExistingCountryTest()
    {
        //given
        $command = new Command\CreateCountry('PL', 'eu', Uuid::uuid4()->toString());
        $this->getCommandBus()->dispatch($command);

        $command = new Command\DeactivateCountry($command->getCode());
