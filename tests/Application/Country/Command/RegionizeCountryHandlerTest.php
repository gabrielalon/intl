 ...
 * @coversNothing
 */
class RegionizeCountryHandlerTest extends HandlerTestCase
{
    public function setUp(): void
    {
        ...
        $this->register(Command\RegionizeCountryHandler::class, new Command\RegionizeCountryHandler($repository));
    }
    ...
    public function itRegionizesExistingCountryTest()
    {
        ...
        $command = new Command\RegionizeCountry($command->getCode(), [['pl' => 'Opolskie']]);
        ...
        $this->assertEquals($entity->regions(), $command->getRegions());
        ...
        foreach ($collection->getArrayCopy() as $eventStream) {
            ...
            $this->assertTrue($entity->getRegions()->equals($event->countryRegions()));
        }
