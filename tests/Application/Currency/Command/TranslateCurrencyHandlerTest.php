 ...
 * @coversNothing
 */
class TranslateCurrencyHandlerTest extends HandlerTestCase
{
    public function setUp(): void
    {
        ...
        $this->register(Command\TranslateCurrencyHandler::class, new Command\TranslateCurrencyHandler($repository));
    }
    ...
    public function itTranslatesExistingCurrencyTest()
    {
        ...
        $command = new Command\TranslateCurrency($command->getCode(), ['pl' => 'test']);
        ...
        foreach ($collection->getArrayCopy() as $eventStream) {
            ...
            $this->assertTrue($entity->getNames()->equals($event->currencyNames()));
        }
